...
app.get('/api/dashboard/ticket-volume', auth, async (_, res) => res.json([{ month: 'Jan', tickets: 4 }, { month: 'Feb', tickets: 6 }, { month: 'Mar', tickets: 5 }, { month: 'Apr', tickets: 8 }, { month: 'May', tickets: 7 }, { month: 'Jun', tickets: 10 }, { month: 'Jul', tickets: 8 }, { month: 'Aug', tickets: 12 }, { month: 'Sep', tickets: 9 }]));
