...
await DeviceMaster.insertMany([
  { serialNumber: 'SAMPLE12345', deviceType: 'MacBook', model: 'MacBook Pro 14', assetId: 'AST-SAMPLE-001', purchaseDate: new Date('2024-03-15'), warrantyStatus: 'Active', warrantyExpiry: new Date('2027-03-15'), amcStatus: 'Active', amcExpiry: new Date('2028-03-15') },
  { serialNumber: 'SAMPLE98765', deviceType: 'MacBook', model: 'MacBook Pro 14', assetId: 'AST-SAMPLE-002', purchaseDate: new Date('2024-05-20'), warrantyStatus: 'Active', warrantyExpiry: new Date('2027-05-20'), amcStatus: 'Expiring Soon', amcExpiry: new Date('2026-11-20') },
